...
import com.yi.easycode.modules.service.GenerateService;
import com.yi.easycode.util.ConfigurationUtil;
import com.yi.easycode.util.GenerateUtil;
import com.yi.easycode.util.JdbcUtil;
import com.yi.easycode.util.WordUtil;
...
public class GenerateServiceImpl implements GenerateService {
    ...
    private Map<String, Object> generateControllerData(GenerateDTO generateDTO) {
        ...
        Map<String, Object> root = new HashMap<>(16);
        generateController.setPackageName("com.yi.easycode.modules.controller");
